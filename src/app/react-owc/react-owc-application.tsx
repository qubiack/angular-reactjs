...
import ReactOwcHero from './react-owc-hero';
...
class ReactOwcApp extends React.Component<IReactApplication, any> {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className={'renderer'}>
        ...
        <br/>
        <ReactOwcHero heroes$={this.state.heroes$}/>
      </div>
    );
  }
}

export class ReactOwcApplication {
  ...
  static initialize(
    ...
    ReactDOM.render(
      <ReactOwcApp injector={injector} heroes$={heroes$}/>,
